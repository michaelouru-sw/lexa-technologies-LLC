      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">What makes us the best choice?</h2>
            <p className="text-xl text-gray-400">
              We have a proven track record of success and are committed to
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                We have a proven track record of success in developing and
            ...
            >
              ...
              <h4 className="h4 mb-2">Flexibility</h4>
              <p className="text-lg text-gray-400 text-center">
                We can adapt to your specific needs and provide a wide range of
                services.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Value</h4>
              <p className="text-lg text-gray-400 text-center">
                We offer competitive pricing and a variety of financing options.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-gray-400 text-center">
                Our team has a wealth of experience in the software industry.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Culture</h4>
              <p className="text-lg text-gray-400 text-center">
